...
public class SuburbSafetyRatingPanel extends SuburbInfoPanel {
	...
	public SuburbSafetyRatingPanel(Context context, String title, String year,
			String walking, String transport) {
		super(context, title);
		...
		yearTV.setPadding(PADDING_VALUE, PADDING_VALUE, PADDING_VALUE,
				PADDING_VALUE);
		yearTV.setLayoutParams(new ViewGroup.LayoutParams(
				ViewGroup.LayoutParams.WRAP_CONTENT,
				ViewGroup.LayoutParams.WRAP_CONTENT));
		...
		walkingTV.setPadding(PADDING_VALUE, PADDING_VALUE, PADDING_VALUE,
				PADDING_VALUE);
		walkingTV.setLayoutParams(new ViewGroup.LayoutParams(
				ViewGroup.LayoutParams.WRAP_CONTENT,
				ViewGroup.LayoutParams.WRAP_CONTENT));
		...
		transportTV.setPadding(PADDING_VALUE, PADDING_VALUE, PADDING_VALUE,
				PADDING_VALUE);
		transportTV.setLayoutParams(new ViewGroup.LayoutParams(
				ViewGroup.LayoutParams.WRAP_CONTENT,
				ViewGroup.LayoutParams.WRAP_CONTENT));
		transportTV.setTextSize(17);
		transportTV.setTextColor(this.getResources().getColor(
				R.color.text_color));
