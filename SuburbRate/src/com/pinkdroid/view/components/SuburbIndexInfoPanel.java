...
public class SuburbIndexInfoPanel extends SuburbInfoPanel {
	...
	public SuburbIndexInfoPanel(Context context, String title, String score,
			String ausRank, String stateRank, String ausPct, String statePct) {
		super(context, title);
		...
		scoreTV.setPadding(PADDING_VALUE, PADDING_VALUE, PADDING_VALUE,
				PADDING_VALUE);
		scoreTV.setLayoutParams(new ViewGroup.LayoutParams(
				ViewGroup.LayoutParams.WRAP_CONTENT,
				ViewGroup.LayoutParams.WRAP_CONTENT));
		...
		ausRankTV.setPadding(PADDING_VALUE, PADDING_VALUE, PADDING_VALUE,
				PADDING_VALUE);
		ausRankTV.setLayoutParams(new ViewGroup.LayoutParams(
				ViewGroup.LayoutParams.WRAP_CONTENT,
				ViewGroup.LayoutParams.WRAP_CONTENT));
		ausRankTV.setTextSize(17);
		ausRankTV
				.setTextColor(this.getResources().getColor(R.color.text_color));
		...
		stateRankTV.setPadding(PADDING_VALUE, PADDING_VALUE, PADDING_VALUE,
				PADDING_VALUE);
		stateRankTV.setLayoutParams(new ViewGroup.LayoutParams(
				ViewGroup.LayoutParams.WRAP_CONTENT,
				ViewGroup.LayoutParams.WRAP_CONTENT));
		stateRankTV.setTextSize(17);
		stateRankTV.setTextColor(this.getResources().getColor(
				R.color.text_color));
