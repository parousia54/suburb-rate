...
public class ItemAutoTextAdapter extends SimpleCursorAdapter implements
	...
	final static int[] to = new int[] { R.id.custom_dropdown_suburb,
			R.id.custom_dropdown_postcode, R.id.custom_dropdown_state };
	final static String[] from = new String[] { "areaname", "postcode",
			"statename" };
	...
	public void onItemClick(AdapterView<?> listView, View view, int position,
		...
		int postcode = Integer.parseInt(c.getString(c
		...
		((SuburbRateHomeScreen) context).getGoButton().setVisibility(
				View.VISIBLE);
