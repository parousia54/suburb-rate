...
public class SuburbRateHomeScreen extends SuburbRateScreen {
	public class ImageAdapter extends BaseAdapter {
		...
		public ImageAdapter(Context c) {
			...
			TypedArray attr = mContext
					.obtainStyledAttributes(R.styleable.SuburbRateHomeScreen);
			mGalleryItemBackground = attr
					.getResourceId(
							R.styleable.SuburbRateHomeScreen_android_galleryItemBackground,
							0);
			attr.recycle();
		}
	...
	public void displaySuburbInfo() {
		Suburb suburb = Controller.getInstance().getApplicationState()
				.getCurrentSuburb();
		...
		if (stats != null) {
			...
			ArrayList<String> images = caller
					.searchBusinessImagesInSuburbByCategories(suburb);
			...
			gallery.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView parent, View v,
					...
					Toast.makeText(SuburbRateHomeScreen.this, "" + position,
			...
			SuburbRatingInfoPanel populationPanel = new SuburbRatingInfoPanel(
					this, "Population", String.valueOf(stats.getPopulation())
							+ " (in " + stats.getDataYear() + ")");
			SuburbSafetyRatingPanel safetyPanel = new SuburbSafetyRatingPanel(
					this, "Safety Ratings", String.valueOf(stats
							.getSafetyYear()), String.valueOf(stats
							.getSafetyWalking()), String.valueOf(stats
							.getSafetyTransport()));
			SuburbIndexInfoPanel economicPanel = new SuburbIndexInfoPanel(this,
					"Economic Resources Index", String.valueOf(stats
							.getEconomic().getScore()), String.valueOf(stats
							.getEconomic().getAus_rank()), String.valueOf(stats
							.getEconomic().getState_rank()),
					String.valueOf(stats.getEconomic().getAus_pct()),
					String.valueOf(stats.getEconomic().getState_pct()));
			SuburbIndexInfoPanel educationPanel = new SuburbIndexInfoPanel(
					this, "Education Index", String.valueOf(stats
							.getEducation().getScore()), String.valueOf(stats
							.getEducation().getAus_rank()),
					String.valueOf(stats.getEducation().getState_rank()),
					String.valueOf(stats.getEducation().getAus_pct()),
					String.valueOf(stats.getEducation().getState_pct()));
			SuburbIndexInfoPanel socioPanel = new SuburbIndexInfoPanel(this,
					"Socio-Economic Ranking", String.valueOf(stats
							.getAdv_disAdv().getScore()), String.valueOf(stats
							.getAdv_disAdv().getAus_rank()),
					String.valueOf(stats.getAdv_disAdv().getState_rank()),
					String.valueOf(stats.getAdv_disAdv().getAus_pct()),
					String.valueOf(stats.getAdv_disAdv().getState_pct()));
			...
			Toast.makeText(this, "No info available for this suburb!!",
					Toast.LENGTH_SHORT).show();
		}
	...
	public void getSuburbInfo() {
		...
		if (suburb != null) {
			...
			Controller.getInstance().getCommunicator()
					.getSuburbInfo(this, suburb);
		}
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		searchInput = (AutoCompleteTextView) this
				.findViewById(R.id.home_screen_search_input);
		ItemAutoTextAdapter itemAdapter = new ItemAutoTextAdapter(this,
