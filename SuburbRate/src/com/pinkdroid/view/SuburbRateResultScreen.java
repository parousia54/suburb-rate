...
public class SuburbRateResultScreen extends SuburbRateScreen {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//
		// LinkedList<SensisContact> contactList = new
		// LinkedList<SensisContact>();
		...
		// Suburb suburb =
		// Controller.getInstance().getApplicationState().getCurrentSuburb();
		...
		// SensisAPICaller.getInstance().searchBusinessesInSuburbByCategories(suburb,
		// catList);
		//
		//
		final QueryResponse response = Controller.getInstance()
				.getApplicationState().getSensisQueryResponse();
		if (response != null) {
			ListView responseListView = (ListView) findViewById(R.id.result_screen_response_listview);
			SensisResponseListViewAdapter adapter = new SensisResponseListViewAdapter(
					this, response);
					...
					.setOnItemClickListener(new AdapterView.OnItemClickListener() {
						...
						public void onItemClick(AdapterView<?> parent,
							...
							Intent intent = new Intent(
									SuburbRateResultScreen.this,
									SuburbRateDirectionScreen.class);
							SensisAddress sAddress = response.getResults()
									.get(pos).getPrimaryAddress();
