...
public class SensisAPICaller {
	...
	public ArrayList<String> searchBusinessImagesInSuburbByCategories(
			Suburb suburb) {
	...
	/*
	 * http://api.sensis.com.au/ob-20110511/test/search?location=-37.81125,144.9656
	 * &key=26zac3pbk9fdq6ane8cqk3s2
	 */
	public int searchPostCodeByLocation(double latitude, double longtitude) {
		...
		parameters.add(new BasicNameValuePair(KEY, sensisApiKey));
		parameters.add(new BasicNameValuePair(LOCATION, "" + latitude + ","
				+ longtitude));
		try {
