...
public class MapItemizedOverlay extends BalloonItemizedOverlay<OverlayItem> {
	...
	public MapItemizedOverlay(SuburbRateMapScreen screen,
			Drawable defaultMarker, MapView mapView) {
	...
	protected boolean onBalloonTap(int index, OverlayItem item) {
		Intent intent = new Intent(screen, SuburbRateDirectionScreen.class);
