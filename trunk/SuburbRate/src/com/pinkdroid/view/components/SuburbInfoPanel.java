...
public class SuburbInfoPanel extends LinearLayout {
	...
	public SuburbInfoPanel(Context context, String title) {
		...
		lp.setMargins(PADDING_VALUE, PADDING_VALUE, PADDING_VALUE,
				PADDING_VALUE);
		this.setLayoutParams(lp);
		this.setOrientation(LinearLayout.VERTICAL);
		this.setPadding(PADDING_VALUE, PADDING_VALUE, PADDING_VALUE,
				PADDING_VALUE);
		this.setBackgroundDrawable(context.getResources().getDrawable(
				R.drawable.product_secondary_panel_bg));
		LinearLayout tiltleLayout = new LinearLayout(context);
		tiltleLayout.setLayoutParams(new ViewGroup.LayoutParams(
				ViewGroup.LayoutParams.FILL_PARENT,
				ViewGroup.LayoutParams.WRAP_CONTENT));

		TextView titleTV = new TextView(context);
		titleTV.setPadding(PADDING_VALUE, PADDING_VALUE, PADDING_VALUE,
				PADDING_VALUE);
