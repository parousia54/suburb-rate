...
public class DatabaseAccessHelper {
	...
	public static boolean cleanDatabase(DatabaseManager dbMananger) {
		try {
			dbMananger.deleteValues(ApplicationConstant.TABLE_SUBURB_NAME,
					null, null);
			dbMananger.deleteValues(ApplicationConstant.TABLE_SQLITE_SEQUENCE,
					null, null);
			System.out
					.println("CURRENT DATABASE HAS BEEN CLEANED................");
	...
	public static Cursor getMatchingSuburbSearch(DatabaseManager dbManager,
			String constraint) {
		Cursor cursor = null;
		String queryString = "SELECT _id, postcode,areaname, statename FROM "
				+ ApplicationConstant.TABLE_SUBURB_NAME;
		if (constraint != null) {
	...
	public static void updateSuburbData(DatabaseManager dbManager,
			String suburbData) {
		dbManager.execSql(suburbData);
	}

	public static void updateSuburbData(DatabaseManager dbManager,
			String postcode, String suburb, String state) {
